...
async function sendMessage(links,page){
    for(let i=0;i<links.length;i++){
        ...
        let msg = `Hi ${name} ! 
I am Mohd Amaan khan , a fourth year student pursuing B.tech from LPU and Currenty looking for internship roles , My key skills are - Strong Problem Solving, C, C++, Java OOPs, DBMS.
I have completed 700+ questions on leetcode nad geeksforgeeks.
